...
SHADOW_CLIENT = "EE5111_Thing2_A0125958R_A0179701B"
...
SHADOW_HANDLER = "EE5111_Thing2_A0125958R_A0179701B"
...
matricNumber = 'Thing2_A0125958R_A0179701B'
...
for x in process.readlines():
    newData = x.split(" ")
    modifiedData = []
    modifiedData.append(str('FD002_' + newData[0]))
